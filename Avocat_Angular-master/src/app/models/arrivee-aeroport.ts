...
export class ArriveeAeroportDto {
  ...
  constructor(numeroCourrier: string,
      ...
      if (!/^04\d{4}$/.test(numeroCourrier)) {
        throw new Error('Le numéro de courrier doit commencer par "04" et avoir 6 chiffres ou caractères.');
      }
